(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var illegalCharacterReg = /[^0-9a-zA-Z\s.,!?:;'"`~@#$%^&*()_+-=[\]{}|<>\\\/]/;
    var replaceIllegalCharacter = function (str) {
        return str.replace(/[^0-9a-zA-Z\s.,!?:;'"`~@#$%^&*()_+-=[\]{}|<>\\\/]/g, '*');
    };
    ...
    var H5log = /** @class */ (function () {
        ...
        Object.defineProperty(H5log.prototype, "log", {
            ...
            value: function (msg, code, level, additionalData) {
                ...
                if (illegalCharacterReg.test(msg)) {
                    msg = replaceIllegalCharacter(msg);
                }
        ...
        Object.defineProperty(H5log.prototype, "normalizePayload", {
            ...
            value: function (payload) {
                ...
                return keys.reduce(function (cur, key) {
                    ...
                    if (typeof data === 'string' && illegalCharacterReg.test(data)) {
                        cur[key] = replaceIllegalCharacter(data);
                    }
                    else if (typeof data === 'object') {
                        try {
                            cur[key] = replaceIllegalCharacter(JSON.stringify(data));
                        }
                        catch (error) {
