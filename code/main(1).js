/*! Copyright © 2011 - 2022 miHoYo. All Rights Reserved */ ! function(e, t) {
	...
	return function(e) {
		...
		var u = function() {
			...
			l = function() {
				function e() {
					this.lang = "", this.isSea = !1, this.config = null, this.prefix = "", this.onClick = null
				}
				return e.init = function(e) {
					...
					if (o || c.some((function(e) {
						...
						f.prefix = a || c.filter((function(e) {
							...
							return r.BROWSER_LIST_CONFIG[e]
						}))[0] || "", f.isSea = n, f.lang = f.getLang(), f.onClick = l, f.request((function(e) {
					...
					t.className = "mihoyo-browser-tips " + (r.IS_MOB ? "mihoyo-browser-tips--mobile" : ""), t.innerHTML = this.formatInnerHTML(e), this.onClick && t.addEventListener("click", this.onClick), window.document.body.appendChild(t)
					...
					return "https://webstatic" + (this.isSea ? ".hoyoverse" : ".mihoyo") + ".com/admin/mi18n/" + (this.isSea ? "plat_oversea" : "plat_cn") + "/m10081518461181/m10081518461181-" + this.lang + ".json"
		...
		function g(e, t) {
			...
			if (t.singleton) {
				var s = l++;
				n = c || (c = v(t)), r = k.bind(null, n, s, !1), i = k.bind(null, n, s, !0)
			} else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = function(e) {
				var t = document.createElement("link");
				return void 0 === e.attrs.type && (e.attrs.type = "text/css"), e.attrs.rel = "stylesheet", m(t, e.attrs), b(e, t), t
			}(t), r = O.bind(null, n, t), i = function() {
				y(n), n.href && URL.revokeObjectURL(n.href)
			}) : (n = v(t), r = x.bind(null, n), i = function() {
				y(n)
			});
			return r(e),
				function(t) {
		...
		Object.defineProperty(t, "__esModule", {
			value: !0
		}), t.isNotExtend = t.IS_MOB = t.BROWSER_LIST_CONFIG = t.isMumu = t.QS = t.qs = t.isIE = void 0;
		var r, i = n(7),
		...
		t.BROWSER_LIST_CONFIG = {
			ie: s,
			mumu: u
		}, t.IS_MOB = "mobile" === o.default.getDeviceType(), t.isNotExtend = function(e) {
			return "-" === e
		}
	}, function(e, t, n) {
				...
				var n = function() {
					...
					i = {
						...
						formatParams: function(e) {
							...
							return Object.keys(t).reduce((function(e, n) {
								return e.push(encodeURIComponent(n) + "=" + encodeURIComponent(t[n])), e
							}), []).join("&")
						},
						getType: function(e) {
						...
						isEmpty: function(e) {
							var t = !0;
							return e && "string" == typeof e && String(e).trim() && (t = !1), t
						},
					...
					o = function() {
						function t(e) {
							...
							}(this, t), this.userAgent = r.toLowerCase(), this.url = i, this.window = n, this.lang = o
						}
						return n(t, [{
							key: "mobile",
							value: function() {
							...
							value: function() {
								var e = void 0;
								return this.desktop() ? e = "desktop" : this.tablet() ? e = "tablet" : this.mobile() ? e = "mobile" : console.warn("unknown device end"), e
							}
						}, {
							key: "getDeviceType",
							value: function() {
		...
		t.COMMON_CONFIG_KEY_MAPS = r(["bg", "slogan", "title_color", "desc_color", "title", "desc", "logo", "btn_color", "text_color", "show_browser"], r([], Array(i), !0).reduce((function(e, t, n) {
			...
			return r(r([], e, !0), i, !0)
		}), []), !0), t.LANG_MAPS = ["zh-cn", "zh-tw", "de-de", "en-us", "es-es", "fr-fr", "id-id", "ja-jp", "ko-kr", "pt-pt", "ru-ru", "th-th", "vi-vn"]
	}, function(e, t, n) {
		"use strict";
		(function(e) {
			Object.defineProperty(t, "__esModule", {
			...
			t.default = {
				...
				getGameLang: function() {
					...
					var n = this.getBrowserInfo(),
						...
						u = a.indexOf("mihoyo"),
						c = r;
					return t ? c = t : i && (c = o.default[this.dealStr(i)]) || (c = this.getDefaultLang(a, u, r)), c
				},
